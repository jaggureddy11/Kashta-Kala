...
object TranslationHelper {
    private val translations = mapOf(
        Language.ENGLISH to mapOf(
            ...
            // Missing Estimator keys
            "estimator_dimensions_title" to "Dimensions",
            "estimator_label_height" to "Thickness / Height",
            "estimator_wood_type" to "Wood Type",
            "estimator_result_title" to "Estimation Result",
            "estimator_result_wood" to "Wood Type",
            "estimator_result_area" to "Surface Area",
            "estimator_result_volume" to "Wood Volume",
            "estimator_result_cost" to "Estimated Material Cost",
            "estimator_result_tip_label" to "💡 Pro Tip",
            "estimator_result_tip_text" to "For load-bearing cabinets, use 18mm plywood carcass and 12mm backing panels.",

            // Missing Quote keys
            "quote_tab_new" to "New Quote",
            "quote_card_customer" to "Customer Details",
            "quote_label_customer_name" to "Customer Name",
            "quote_label_item_name" to "Item Name",
            "quote_card_dimensions" to "Dimensions",
            "quote_label_selected_wood" to "Selected Wood Type",
            "quote_card_cost" to "Cost Calculation",
            "quote_label_labour" to "Labour Cost (Rs)",
            "quote_label_overhead" to "Overhead / Profit (%)",
            "quote_summary_material" to "Material Cost",
            "quote_summary_labour" to "Labour Cost",
            "quote_summary_overhead" to "Overhead / Margin",
            "quote_summary_total" to "Total Quote Price",
            "quote_btn_share" to "Share Quote",
            "quote_btn_save" to "Save Quote",
        ...
        Language.KANNADA to mapOf(
            ...
            // Missing Estimator keys
            "estimator_dimensions_title" to "ಅಳತೆಗಳು",
            "estimator_label_height" to "ದಪ್ಪ / ಎತ್ತರ",
            "estimator_wood_type" to "ಮರದ ವಿಧ",
            "estimator_result_title" to "ಅಂದಾಜು ಫಲಿತಾಂಶ",
            "estimator_result_wood" to "ಮರದ ವಿಧ",
            "estimator_result_area" to "ಮೇಲ್ಮೈ ವಿಸ್ತೀರ್ಣ",
            "estimator_result_volume" to "ಮರದ ಗಾತ್ರ (Volume)",
            "estimator_result_cost" to "ಅಂದಾಜು ಮರದ ವೆಚ್ಚ",
            "estimator_result_tip_label" to "💡 ಉಪಯುಕ್ತ ಸಲಹೆ",
            "estimator_result_tip_text" to "ಭಾರ ಹೊರುವ ಕಪಾಟುಗಳಿಗೆ 18 ಮಿಮೀ ಪ್ಲೈವುಡ್ ಮತ್ತು ಹಿಂಭಾಗಕ್ಕೆ 12 ಮಿಮೀ ಬೋರ್ಡ್ ಬಳಸಿ.",

            // Missing Quote keys
            "quote_tab_new" to "ಹೊಸ ಕೋಟ್",
            "quote_card_customer" to "ಗ್ರಾಹಕರ ವಿವರಗಳು",
            "quote_label_customer_name" to "ಗ್ರಾಹಕರ ಹೆಸರು",
            "quote_label_item_name" to "ವಸ್ತುವಿನ ಹೆಸರು",
            "quote_card_dimensions" to "ಅಳತೆಗಳು",
            "quote_label_selected_wood" to "ಆಯ್ಕೆ ಮಾಡಿದ ಮರ",
            "quote_card_cost" to "ವೆಚ್ಚದ ಲೆಕ್ಕಾಚಾರ",
            "quote_label_labour" to "ಕೂಲಿ ವೆಚ್ಚ (ರೂ)",
            "quote_label_overhead" to "ಹೆಚ್ಚುವರಿ ವೆಚ್ಚ / ಲಾಭ (%)",
            "quote_summary_material" to "ವಸ್ತುಗಳ ವೆಚ್ಚ",
            "quote_summary_labour" to "ಕೂಲಿ ವೆಚ್ಚ",
            "quote_summary_overhead" to "ಹೆಚ್ಚುವರಿ / ಲಾಭ",
            "quote_summary_total" to "ಒಟ್ಟು ಕೋಟ್ ಬೆಲೆ",
            "quote_btn_share" to "ಕೋಟ್ ಹಂಚಿಕೊಳ್ಳಿ",
            "quote_btn_save" to "ಕೋಟ್ ಉಳಿಸಿ",
        ...
        Language.TELUGU to mapOf(
            ...
            // Missing Estimator keys
            "estimator_dimensions_title" to "కొలతలు",
            "estimator_label_height" to "మందం / ఎత్తు",
            "estimator_wood_type" to "కలప రకం",
            "estimator_result_title" to "అంచనా ఫలితం",
            "estimator_result_wood" to "కలప రకం",
            "estimator_result_area" to "ఉపరితల వైశాల్యం",
            "estimator_result_volume" to "కలప పరిమాణం",
            "estimator_result_cost" to "అంచనా వేసిన మెటీరియల్ ఖర్చు",
            "estimator_result_tip_label" to "💡 ఉపయోగకరమైన చిట్కా",
            "estimator_result_tip_text" to "బరువు మోసే క్యాబినెట్‌ల కోసం 18 మిమీ ప్లైవుడ్ మరియు వెనుక భాగంలో 12 మిమీ బోర్డు ఉపయోగించండి.",

            // Missing Quote keys
            "quote_tab_new" to "కొత్త కోట్",
            "quote_card_customer" to "కస్టమర్ వివరాలు",
            "quote_label_customer_name" to "కస్టమర్ పేరు",
            "quote_label_item_name" to "వస్తువు పేరు",
            "quote_card_dimensions" to "కొలతలు",
            "quote_label_selected_wood" to "ఎంచుకున్న కలప",
            "quote_card_cost" to "ధర లెక్కింపు",
            "quote_label_labour" to "కూలి ఖర్చు (రూ)",
            "quote_label_overhead" to "అదనపు ఖర్చులు / లాభం (%)",
            "quote_summary_material" to "మెటీరియల్ ఖర్చు",
            "quote_summary_labour" to "కూలి ఖర్చు",
            "quote_summary_overhead" to "అదనపు / మార్జిన్",
            "quote_summary_total" to "మొత్తం కోట్ ధర",
            "quote_btn_share" to "కోట్ షేర్ చేయి",
            "quote_btn_save" to "కోట్ సేవ్ చేయి",
        ...
        Language.HINDI to mapOf(
            ...
            // Missing Estimator keys
            "estimator_dimensions_title" to "माप (Dimensions)",
            "estimator_label_height" to "मोटाई / ऊंचाई",
            "estimator_wood_type" to "लकड़ी का प्रकार",
            "estimator_result_title" to "अनुमान का परिणाम",
            "estimator_result_wood" to "लकड़ी का प्रकार",
            "estimator_result_area" to "सतह का क्षेत्रफल",
            "estimator_result_volume" to "लकड़ी का आयतन",
            "estimator_result_cost" to "अनुमानित सामग्री लागत",
            "estimator_result_tip_label" to "💡 काम की बात",
            "estimator_result_tip_text" to "भारी अलमारी के फ्रेम के लिए 18 मिमी प्लाईवुड और पीछे 12 मिमी बोर्ड का उपयोग करें।",

            // Missing Quote keys
            "quote_tab_new" to "नया कोटेशन",
            "quote_card_customer" to "ग्राहक का विवरण",
            "quote_label_customer_name" to "ग्राहक का नाम",
            "quote_label_item_name" to "आइटम का नाम",
            "quote_card_dimensions" to "माप (Dimensions)",
            "quote_label_selected_wood" to "चयनित लकड़ी",
            "quote_card_cost" to "लागत की गणना",
            "quote_label_labour" to "श्रम लागत (रु)",
            "quote_label_overhead" to "अतिरिक्त खर्च / लाभ (%)",
            "quote_summary_material" to "सामग्री की लागत",
            "quote_summary_labour" to "श्रम लागत",
            "quote_summary_overhead" to "अतिरिक्त / मार्जिन",
            "quote_summary_total" to "कुल कोटेशन मूल्य",
            "quote_btn_share" to "कोटेशन साझा करें",
            "quote_btn_save" to "कोटेशन सुरक्षित करें",
